...
export type CountryCode<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = Nullable<$Scalar<'CountryCode', $Context>>
export type CountryCode$NonNull<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = NonNull<$Scalar<'CountryCode', $Context>>
export type FuzzyDateInt<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = Nullable<$Scalar<'FuzzyDateInt', $Context>>
export type FuzzyDateInt$NonNull<$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> = NonNull<$Scalar<'FuzzyDateInt', $Context>>
