...
export type * as StatusDistribution from './__.js'
...
* | **Fields** | 2 |
*/
export interface StatusDistribution<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$StatusDistribution} |
