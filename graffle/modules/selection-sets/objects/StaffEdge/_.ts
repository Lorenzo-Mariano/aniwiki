...
export type * as StaffEdge from './__.js'
...
* | **Fields** | 4 |
*/
export interface StaffEdge<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$StaffEdge} |
* | **Path** | `StaffEdge.node` |
