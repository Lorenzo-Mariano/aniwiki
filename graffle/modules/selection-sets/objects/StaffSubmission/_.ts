...
export type * as StaffSubmission from './__.js'
...
* | **Fields** | 10 |
*/
export interface StaffSubmission<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$StaffSubmission} |
* | **Path** | `StaffSubmission.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$StaffSubmission} |
* | **Path** | `StaffSubmission.submission` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$StaffSubmission} |
* | **Path** | `StaffSubmission.submitter` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$StaffSubmission} |
* | **Path** | `StaffSubmission.createdAt` |
* | **Nullability** | Optional |
*/
