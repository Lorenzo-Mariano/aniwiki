...
export type * as UserScoreStatistic from './__.js'
...
* | **Fields** | 6 |
*/
export interface UserScoreStatistic<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserScoreStatistic} |
* | **Path** | `UserScoreStatistic.count` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserScoreStatistic} |
* | **Path** | `UserScoreStatistic.meanScore` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserScoreStatistic} |
* | **Path** | `UserScoreStatistic.minutesWatched` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserScoreStatistic} |
* | **Path** | `UserScoreStatistic.chaptersRead` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserScoreStatistic} |
* | **Path** | `UserScoreStatistic.mediaIds` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
