...
export type * as ActivityReplyLikeNotification from './__.js'
...
* | **Fields** | 8 |
*/
export interface ActivityReplyLikeNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.userId` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.type` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.activityId` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.context` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.createdAt` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.activity` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplyLikeNotification} |
* | **Path** | `ActivityReplyLikeNotification.user` |
* | **Nullability** | Optional |
*/
