...
export type * as ThreadLikeNotification from './__.js'
...
* | **Fields** | 9 |
*/
export interface ThreadLikeNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ThreadLikeNotification} |
