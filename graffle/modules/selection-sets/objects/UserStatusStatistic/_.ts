...
export type * as UserStatusStatistic from './__.js'
...
* | **Fields** | 6 |
*/
export interface UserStatusStatistic<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.count` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.meanScore` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.minutesWatched` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.chaptersRead` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.mediaIds` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Parent** | {@link $NamedTypes.$UserStatusStatistic} |
* | **Path** | `UserStatusStatistic.status` |
