...
export type * as ActivityReplyNotification from './__.js'
...
* | **Fields** | 8 |
*/
export interface ActivityReplyNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ActivityReplyNotification} |
