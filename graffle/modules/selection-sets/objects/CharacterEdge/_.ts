...
export type * as CharacterEdge from './__.js'
...
* | **Fields** | 8 |
*/
export interface CharacterEdge<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$CharacterEdge} |
