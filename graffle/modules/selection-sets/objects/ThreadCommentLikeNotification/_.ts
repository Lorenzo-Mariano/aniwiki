...
export type * as ThreadCommentLikeNotification from './__.js'
...
* | **Fields** | 9 |
*/
export interface ThreadCommentLikeNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.userId` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.type` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.commentId` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.context` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.createdAt` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.thread` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.comment` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#graphqlobjecttype | OutputObject ↗} |
* | **Parent** | {@link $NamedTypes.$ThreadCommentLikeNotification} |
* | **Path** | `ThreadCommentLikeNotification.user` |
* | **Nullability** | Optional |
*/
