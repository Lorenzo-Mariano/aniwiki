...
export type * as StaffRoleType from './__.js'
...
* | **Fields** | 3 |
*/
export interface StaffRoleType<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$StaffRoleType} |
