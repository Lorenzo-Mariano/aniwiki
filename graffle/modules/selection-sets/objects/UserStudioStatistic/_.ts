...
export type * as UserStudioStatistic from './__.js'
...
* | **Fields** | 6 |
*/
export interface UserStudioStatistic<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserStudioStatistic} |
