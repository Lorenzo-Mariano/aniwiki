...
export type * as ScoreDistribution from './__.js'
...
* | **Fields** | 2 |
*/
export interface ScoreDistribution<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ScoreDistribution} |
