...
export type * as UserGenreStatistic from './__.js'
...
* | **Fields** | 6 |
*/
export interface UserGenreStatistic<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.count` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.meanScore` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.minutesWatched` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.chaptersRead` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.mediaIds` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserGenreStatistic} |
* | **Path** | `UserGenreStatistic.genre` |
* | **Nullability** | Optional |
*/
genre?: $Fields.genre.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.genre<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
