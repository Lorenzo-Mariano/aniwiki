...
export type * as UserReleaseYearStatistic from './__.js'
...
* | **Fields** | 6 |
*/
export interface UserReleaseYearStatistic<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.count` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.meanScore` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.minutesWatched` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.chaptersRead` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.mediaIds` |
* | **Nullability** | Required |
* | **List** | Yes |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$UserReleaseYearStatistic} |
* | **Path** | `UserReleaseYearStatistic.releaseYear` |
* | **Nullability** | Optional |
*/
releaseYear?: $Fields.releaseYear.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.releaseYear<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
