...
export type * as RelatedMediaAdditionNotification from './__.js'
...
* | **Fields** | 6 |
*/
export interface RelatedMediaAdditionNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RelatedMediaAdditionNotification} |
