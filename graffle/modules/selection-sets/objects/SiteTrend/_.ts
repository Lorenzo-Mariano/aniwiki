...
export type * as SiteTrend from './__.js'
...
* | **Fields** | 3 |
*/
export interface SiteTrend<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$SiteTrend} |
* | **Path** | `SiteTrend.date` |
...
* | **Nullability** | Required |
*/
change?: $Fields.change.$Expanded<_$Context>| GraphqlKit.Document.Object.Select.SelectAlias.SelectAlias<$Fields.change<_$Context>> | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasShort | GraphqlKit.Document.Object.Select.SelectAlias.SelectAliasString
