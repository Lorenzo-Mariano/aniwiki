...
export type * as RevisionHistory from './__.js'
...
* | **Fields** | 10 |
*/
export interface RevisionHistory<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$RevisionHistory} |
...
* | | |
* | - | - |
* | **Type** | {@link $NamedTypes.$RevisionHistoryAction} |
