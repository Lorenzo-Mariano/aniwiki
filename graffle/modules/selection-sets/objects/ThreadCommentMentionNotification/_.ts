...
export type * as ThreadCommentMentionNotification from './__.js'
...
* | **Fields** | 9 |
*/
export interface ThreadCommentMentionNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ThreadCommentMentionNotification} |
