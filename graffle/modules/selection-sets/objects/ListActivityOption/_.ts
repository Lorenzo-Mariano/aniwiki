...
export type * as ListActivityOption from './__.js'
...
* | **Fields** | 2 |
*/
export interface ListActivityOption<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ListActivityOption} |
* | **Path** | `ListActivityOption.disabled` |
