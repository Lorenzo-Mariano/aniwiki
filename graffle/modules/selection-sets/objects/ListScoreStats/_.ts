...
export type * as ListScoreStats from './__.js'
...
* | **Fields** | 2 |
*/
export interface ListScoreStats<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ListScoreStats} |
