...
export type * as ThreadCommentReplyNotification from './__.js'
...
* | **Fields** | 9 |
*/
export interface ThreadCommentReplyNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ThreadCommentReplyNotification} |
