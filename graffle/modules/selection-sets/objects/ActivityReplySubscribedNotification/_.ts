...
export type * as ActivityReplySubscribedNotification from './__.js'
...
* | **Fields** | 8 |
*/
export interface ActivityReplySubscribedNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.id` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.userId` |
* | **Nullability** | Required |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.type` |
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.activityId` |
* | **Nullability** | Required |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.context` |
* | **Nullability** | Optional |
*/
...
* | **Kind** | {@link https://graphql.org/graphql-js/type/#scalars | ScalarStandard ↗} |
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.createdAt` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.activity` |
* | **Nullability** | Optional |
*/
...
* | **Parent** | {@link $NamedTypes.$ActivityReplySubscribedNotification} |
* | **Path** | `ActivityReplySubscribedNotification.user` |
* | **Nullability** | Optional |
*/
