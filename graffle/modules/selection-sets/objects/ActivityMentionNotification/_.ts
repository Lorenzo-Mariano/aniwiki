...
export type * as ActivityMentionNotification from './__.js'
...
* | **Fields** | 8 |
*/
export interface ActivityMentionNotification<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$ActivityMentionNotification} |
