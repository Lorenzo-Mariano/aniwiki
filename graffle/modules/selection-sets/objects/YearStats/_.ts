...
export type * as YearStats from './__.js'
...
* | **Fields** | 3 |
*/
export interface YearStats<_$Context extends GraphqlKit.Document.Object.Select.SelectionContext = $DefaultSelectionContext> extends GraphqlKit.Document.Object.Select.Bases.ObjectLike {
...
* | **Parent** | {@link $NamedTypes.$YearStats} |
* | **Path** | `YearStats.year` |
